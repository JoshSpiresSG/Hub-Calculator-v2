        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <p className="text-xs text-gray-600 mt-1">{formatCurrency(results.hubtCost / (results.inputAirtimeHours * 12 || 1))}/hour airtime</p>
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600 mt-1">Hub infrastructure cost</p>
              <p className="text-xs text-gray-600 mt-1">{formatCurrency(results.totalDroneBoxCost / (results.inputAirtimeHours * 12 || 1))}/hour airtime</p>
